...
class MainPage(BasePage):
    ...
    def redirection_to_the_cart_page(self):
        cart_button = self.search_element(main_page_locators.CART_BUTTON)
        cart_button.click()

    def redirection_to_the_login_page(self):
        login_button = self.search_element(main_page_locators.LOGIN_BUTTON)
        login_button.click()

    def checking_cart(self):
        is_there_goods = self.search_element(main_page_locators.EMPTY_CART).text
